...
---
## Summary
Going to investigate Central Limit Theorem using repeated draws from exponential distribution.  
...
For a lambda of 0.2, the probability density for the Exponential distribution is shown below. In this case, the mean is 5 and the standard deviation is 5.
